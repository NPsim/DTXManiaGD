...
namespace DTXMania
{
    ...
    internal abstract class CStage演奏画面共通 : CStage
    {
        ...
        #region [ t演奏結果を格納する_KMD_ドラム() ]
        public void t演奏結果を格納する_KMD_ドラム(out CScoreIni.C演奏記録 Drums)
        {
            ...
            if (CDTXMania.DTX.bチップがある.Drums && !CDTXMania.ConfigIni.bギタレボモード)
            {
                ...
                {
                    Drums.dbゲーム型スキル値 = CScoreIni.t旧ゲーム型スキルを計算して返す(CDTXMania.DTX.LEVEL.Drums, CDTXMania.DTX.LEVELDEC.Drums, CDTXMania.DTX.n可視チップ数.Drums, this.nヒット数_KMD_Auto含まない.Drums.Perfect, this.actCombo.n現在のコンボ数.最高値.Drums, E楽器パート.DRUMS, bIsAutoPlay);
                    Drums.db演奏型スキル値 = CScoreIni.t旧演奏型スキルを計算して返す(CDTXMania.DTX.n可視チップ数.Drums, this.nヒット数_KMD_Auto含まない.Drums.Perfect, this.nヒット数_KMD_Auto含まない.Drums.Great, this.nヒット数_KMD_Auto含まない.Drums.Good, this.nヒット数_KMD_Auto含まない.Drums.Poor, this.nヒット数_KMD_Auto含まない.Drums.Miss, E楽器パート.DRUMS, bIsAutoPlay);
                }
                else if (CDTXMania.ConfigIni.nSkillMode == 1)
                {
                    Drums.dbゲーム型スキル値 = CScoreIni.tゲーム型スキルを計算して返す(CDTXMania.DTX.LEVEL.Drums, CDTXMania.DTX.LEVELDEC.Drums, CDTXMania.DTX.n可視チップ数.Drums, this.nヒット数_KMD_Auto含まない.Drums.Perfect, this.nヒット数_KMD_Auto含まない.Drums.Great, this.actCombo.n現在のコンボ数.最高値.Drums, E楽器パート.DRUMS, bIsAutoPlay);
                    Drums.db演奏型スキル値 = CScoreIni.t演奏型スキルを計算して返す(CDTXMania.DTX.n可視チップ数.Drums, this.nヒット数_KMD_Auto含まない.Drums.Perfect, this.nヒット数_KMD_Auto含まない.Drums.Great, this.nヒット数_KMD_Auto含まない.Drums.Good, this.nヒット数_KMD_Auto含まない.Drums.Poor, this.nヒット数_KMD_Auto含まない.Drums.Miss, this.actCombo.n現在のコンボ数.最高値.Drums, E楽器パート.DRUMS, bIsAutoPlay);
                }
                Drums.nPerfect数 = CDTXMania.ConfigIni.bドラムが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Drums.Perfect : this.nヒット数_KMD_Auto含まない.Drums.Perfect;
                Drums.nGreat数 = CDTXMania.ConfigIni.bドラムが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Drums.Great : this.nヒット数_KMD_Auto含まない.Drums.Great;
                Drums.nGood数 = CDTXMania.ConfigIni.bドラムが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Drums.Good : this.nヒット数_KMD_Auto含まない.Drums.Good;
                Drums.nPoor数 = CDTXMania.ConfigIni.bドラムが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Drums.Poor : this.nヒット数_KMD_Auto含まない.Drums.Poor;
                Drums.nMiss数 = CDTXMania.ConfigIni.bドラムが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Drums.Miss : this.nヒット数_KMD_Auto含まない.Drums.Miss;
                Drums.nPerfect数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Drums.Perfect;
                Drums.nGreat数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Drums.Great;
                Drums.nGood数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Drums.Good;
                Drums.nPoor数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Drums.Poor;
                Drums.nMiss数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Drums.Miss;
        ...
        #endregion
        #region [ t演奏結果を格納する_KMD_ギター() ]
        public void t演奏結果を格納する_KMD_ギター(out CScoreIni.C演奏記録 Guitar)
        {
            ...
            if (CDTXMania.DTX.bチップがある.Guitar)
            {
                ...
                Guitar.dbゲーム型スキル値 = CScoreIni.tゲーム型スキルを計算して返す(CDTXMania.DTX.LEVEL.Guitar, CDTXMania.DTX.LEVELDEC.Guitar, CDTXMania.DTX.n可視チップ数.Guitar, this.nヒット数_KMD_Auto含まない.Guitar.Perfect, this.nヒット数_KMD_Auto含まない.Guitar.Great, this.actCombo.n現在のコンボ数.最高値.Guitar, E楽器パート.GUITAR, bIsAutoPlay);
                Guitar.db演奏型スキル値 = CScoreIni.t演奏型スキルを計算して返す(CDTXMania.DTX.n可視チップ数.Guitar, this.nヒット数_KMD_Auto含まない.Guitar.Perfect, this.nヒット数_KMD_Auto含まない.Guitar.Great, this.nヒット数_KMD_Auto含まない.Guitar.Good, this.nヒット数_KMD_Auto含まない.Guitar.Poor, this.nヒット数_KMD_Auto含まない.Guitar.Miss, this.actCombo.n現在のコンボ数.最高値.Guitar, E楽器パート.GUITAR, bIsAutoPlay);
                Guitar.nPerfect数 = CDTXMania.ConfigIni.bギターが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Guitar.Perfect : this.nヒット数_KMD_Auto含まない.Guitar.Perfect;
                Guitar.nGreat数 = CDTXMania.ConfigIni.bギターが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Guitar.Great : this.nヒット数_KMD_Auto含まない.Guitar.Great;
                Guitar.nGood数 = CDTXMania.ConfigIni.bギターが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Guitar.Good : this.nヒット数_KMD_Auto含まない.Guitar.Good;
                Guitar.nPoor数 = CDTXMania.ConfigIni.bギターが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Guitar.Poor : this.nヒット数_KMD_Auto含まない.Guitar.Poor;
                Guitar.nMiss数 = CDTXMania.ConfigIni.bギターが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Guitar.Miss : this.nヒット数_KMD_Auto含まない.Guitar.Miss;
                Guitar.nPerfect数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Guitar.Perfect;
                Guitar.nGreat数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Guitar.Great;
                Guitar.nGood数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Guitar.Good;
                Guitar.nPoor数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Guitar.Poor;
                Guitar.nMiss数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Guitar.Miss;
        ...
        #endregion
        #region [ t演奏結果を格納する_KMD_ベース() ]
        public void t演奏結果を格納する_KMD_ベース(out CScoreIni.C演奏記録 Bass)
        {
            ...
            if (CDTXMania.DTX.bチップがある.Bass)
            {
                ...
                Bass.dbゲーム型スキル値 = CScoreIni.tゲーム型スキルを計算して返す(CDTXMania.DTX.LEVEL.Bass, CDTXMania.DTX.LEVELDEC.Bass, CDTXMania.DTX.n可視チップ数.Bass, this.nヒット数_KMD_Auto含まない.Bass.Perfect, this.nヒット数_KMD_Auto含まない.Bass.Great, this.actCombo.n現在のコンボ数.最高値.Bass, E楽器パート.BASS, bIsAutoPlay);
                Bass.db演奏型スキル値 = CScoreIni.t演奏型スキルを計算して返す(CDTXMania.DTX.n可視チップ数.Bass, this.nヒット数_KMD_Auto含まない.Bass.Perfect, this.nヒット数_KMD_Auto含まない.Bass.Great, this.nヒット数_KMD_Auto含まない.Bass.Good, this.nヒット数_KMD_Auto含まない.Bass.Poor, this.nヒット数_KMD_Auto含まない.Bass.Miss, this.actCombo.n現在のコンボ数.最高値.Bass, E楽器パート.BASS, bIsAutoPlay);
                Bass.nPerfect数 = CDTXMania.ConfigIni.bベースが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Bass.Perfect : this.nヒット数_KMD_Auto含まない.Bass.Perfect;
                Bass.nGreat数 = CDTXMania.ConfigIni.bベースが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Bass.Great : this.nヒット数_KMD_Auto含まない.Bass.Great;
                Bass.nGood数 = CDTXMania.ConfigIni.bベースが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Bass.Good : this.nヒット数_KMD_Auto含まない.Bass.Good;
                Bass.nPoor数 = CDTXMania.ConfigIni.bベースが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Bass.Poor : this.nヒット数_KMD_Auto含まない.Bass.Poor;
                Bass.nMiss数 = CDTXMania.ConfigIni.bベースが全部オートプレイである ? this.nヒット数_KMD_Auto含む.Bass.Miss : this.nヒット数_KMD_Auto含まない.Bass.Miss;
                Bass.nPerfect数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Bass.Perfect;
                Bass.nGreat数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Bass.Great;
                Bass.nGood数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Bass.Good;
                Bass.nPoor数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Bass.Poor;
                Bass.nMiss数_KMD_Auto含まない = this.nヒット数_KMD_Auto含まない.Bass.Miss;
        ...
        public override void On活性化()
        {
            ...
            for (int k = 0; k < 3; k++)
            {
                //for ( int n = 0; n < 5; n++ )
                {
                    this.nヒット数_KMD_Auto含まない[ k ] = new CHITCOUNTOFRANK();
                    this.nヒット数_KMD_Auto含む[ k ] = new CHITCOUNTOFRANK();
            ...
            foreach (CDTX.CChip pChip in listChip)
            {
                ...
                if (pChip.n発声時刻ms <= 0)
                {
                    if (pChip.nチャンネル番号 == 0xEA)
                    {
                        ...
                        {
                            CDTX.CWAV wc = listWAV[pChip.n整数値_KMD_内部番号];
...
//      protected CAct演奏パネル文字列 actPanel;
        ...
        public STDGBVALUE<CHITCOUNTOFRANK> nヒット数_KMD_Auto含まない;
        public STDGBVALUE<CHITCOUNTOFRANK> nヒット数_KMD_Auto含む;
        ...
        protected CTexture txPerfectZone; // 2019.12.24 sub; Add Perfect hit zone
        ...
        protected CDTX.CChip r指定時刻に一番近いChip_KMD_ヒット未済問わず不可視考慮(long nTime, int nChannel, int nInputAdjustTime)
        {
            sw2.Start();
                        ...
                        #region [ DRUMS ]
                        {
                            ...
                            switch (index)
                            {
                                ...
                                case 0x27:
                                    ...
                                    if (!this.L最後に再生したHHの実WAV番号.Contains(pChip.n整数値_KMD_内部番号))
                                    {
                                        this.L最後に再生したHHの実WAV番号.Add(pChip.n整数値_KMD_内部番号);
                                    }
                                    break;
                            }

                            CDTXMania.DTX.tチップの再生(pChip, n再生開始システム時刻ms, nLane, n音量, bモニタ);
                            this.n最後に再生した実WAV番号[nLane] = pChip.n整数値_KMD_内部番号;		// nLaneでなくindexにすると、LC(1A-11=09)とギター(enumで09)がかぶってLC音が消されるので注意
                            return;
                        }
                        #endregion
                    case E楽器パート.GUITAR:
                        ...
                        this.n最後に再生した実WAV番号.Guitar = pChip.n整数値_KMD_内部番号;
                        return;
                        #endregion
                    case E楽器パート.BASS:
                        #region [ BASS ]
                        ...
                        this.n最後に再生した実WAV番号.Bass = pChip.n整数値_KMD_内部番号;
                        return;
                        #endregion
            ...
            switch (pChip.e楽器パート)
            {
                case E楽器パート.DRUMS:
                    switch (eJudgeResult)
                    {
                        ...
                        case E判定.Bad:
                            ...
                            this.nヒット数_KMD_Auto含む.Drums.Miss++;
                            if (!bPChipIsAutoPlay)
                            {
                                this.nヒット数_KMD_Auto含まない.Drums.Miss++;
                                this.actPlayInfo.nMISS数++;
                            }
                            break;
                        case E判定.Poor:
                            this.nヒット数_KMD_Auto含む.Drums.Poor++;
                            if (!bPChipIsAutoPlay)
                            {
                                this.nヒット数_KMD_Auto含まない.Drums.Poor++;
                                this.actPlayInfo.nPOOR数++;
                            }
                            break;
                        case E判定.Good:
                            this.nヒット数_KMD_Auto含む.Drums.Good++;
                            if (!bPChipIsAutoPlay)
                            {
                                this.nヒット数_KMD_Auto含まない.Drums.Good++;
                                this.actPlayInfo.nGOOD数++;
                            }
                            break;
                        case E判定.Great:
                            this.nヒット数_KMD_Auto含む.Drums.Great++;
                            if (!bPChipIsAutoPlay)
                            {
                                this.nヒット数_KMD_Auto含まない.Drums.Great++;
                                this.actPlayInfo.nGREAT数++;
                            }
                            break;
                        case E判定.Perfect:
                            this.nヒット数_KMD_Auto含む.Drums.Perfect++;
                            if (!bPChipIsAutoPlay)
                            {
                                this.nヒット数_KMD_Auto含まない.Drums.Perfect++;
                ...
                case E楽器パート.BASS:
                    ...
                    switch (eJudgeResult)
                    {
                        case E判定.Miss:
                        case E判定.Bad:
                            this.nヒット数_KMD_Auto含む[indexInst].Miss++;
                            if (!bPChipIsAutoPlay)
                            {
                                this.nヒット数_KMD_Auto含まない[indexInst].Miss++;
                            }
                            break;
                        default:	// #24068 2011.1.10 ikanick changed
                            // #24167 2011.1.16 yyagi changed
                            this.nヒット数_KMD_Auto含む[indexInst][(int)eJudgeResult]++;
                            if (!bPChipIsAutoPlay)
                            {
                                this.nヒット数_KMD_Auto含まない[indexInst][(int)eJudgeResult]++;
                            }
                            break;
                    }
                    switch (eJudgeResult)
                ...
                if (CDTXMania.ConfigIni.bAutoAddGage == true)
                {
                    if (((pChip.e楽器パート == E楽器パート.DRUMS)) && (eJudgeResult != E判定.Miss) && (eJudgeResult != E判定.Bad))
                    {
                        ...
                        if (eJudgeResult == E判定.Perfect)//ここでパフェ基準を作成。
                        {
                            ...
                            else if (this.nヒット数_KMD_Auto含む.Drums.Perfect >= nComboMax)
                            {
                        ...
                        else if (nCombos == nComboMax || this.nヒット数_KMD_Auto含まない.Drums.Perfect == nComboMax)
                        {
                        }
                        else
                        {
                    ...
                    else if (((pChip.e楽器パート == E楽器パート.GUITAR) || pChip.e楽器パート == E楽器パート.BASS) && (eJudgeResult != E判定.Miss) && (eJudgeResult != E判定.Bad))
                    {
                        ...
                        if (eJudgeResult == E判定.Perfect || eJudgeResult == E判定.Auto)//ここでパフェ基準を作成。
                        {
                            ...
                            else if (this.nヒット数_KMD_Auto含む[(int)pChip.e楽器パート].Perfect >= nComboMax)
                            {
                        ...
                        else if (nCombos == nComboMax || this.nヒット数_KMD_Auto含まない[(int)pChip.e楽器パート].Perfect == nComboMax)
                        {
                        }
                        else
                        {
        ...
        protected abstract void tチップのヒット処理_KMD_BadならびにTight時のMiss(E楽器パート part);
        protected abstract void tチップのヒット処理_KMD_BadならびにTight時のMiss(E楽器パート part, int nLane);
        protected void tチップのヒット処理_KMD_BadならびにTight時のMiss(E楽器パート part, E楽器パート screenmode)
        {
            this.tチップのヒット処理_KMD_BadならびにTight時のMiss(part, 0, screenmode);
        }
        protected void tチップのヒット処理_KMD_BadならびにTight時のMiss(E楽器パート part, int nLane, E楽器パート screenmode)
        {
            this.bAUTOでないチップが１つでもバーを通過した = true;
        ...
        protected abstract void t入力処理_KMD_ドラム();
        ...
        protected void tキー入力()
        {
            ...
            if (((base.eフェーズID != CStage.Eフェーズ.演奏_STAGE_FAILED)) && (base.eフェーズID != CStage.Eフェーズ.演奏_STAGE_FAILED_フェードアウト))
            {
                ...
                {
                    this.t入力処理_KMD_ドラム();
                    this.t入力処理_KMD_ギターベース(E楽器パート.GUITAR);
                    this.t入力処理_KMD_ギターベース(E楽器パート.BASS);
                }
...
//      protected abstract void t進行描画_KMD_AVI();
        protected void t進行描画_KMD_AVI()
        {
        ...
        /*
        protected abstract void t進行描画_KMD_BGA();
        protected void t進行描画_KMD_BGA(int x, int y)
        {
         ...
         */
        protected abstract void t進行描画_KMD_DANGER();
        protected void t進行描画_KMD_MIDIBGM()
        {
        ...
        protected void t進行描画_KMD_RGBボタン()
        {
            this.actRGB.On進行描画();
        }
        protected void t進行描画_KMD_STAGEFAILED()
        {
        ...
        protected void t進行描画_KMD_WailingBonus()
        {
            if ((base.eフェーズID != CStage.Eフェーズ.演奏_STAGE_FAILED) && (base.eフェーズID != CStage.Eフェーズ.演奏_STAGE_FAILED_フェードアウト))
            {
        ...
        protected abstract void t進行描画_KMD_Wailing枠();
        protected void t進行描画_KMD_Wailing枠(int GtWailingFrameX, int BsWailingFrameX, int GtWailingFrameY, int BsWailingFrameY)
        {
        ...
        protected void t進行描画_KMD_チップファイアGB()
        {
            this.actChipFireGB.On進行描画();
        }

        /*
        protected abstract void t進行描画_KMD_パネル文字列();
        protected void t進行描画_KMD_パネル文字列()
        {
            if ((base.eフェーズID != CStage.Eフェーズ.演奏_STAGE_FAILED) && (base.eフェーズID != CStage.Eフェーズ.演奏_STAGE_FAILED_フェードアウト))
            {
                this.actPanel.t進行描画();
        ...
        protected void t進行描画_KMD_ゲージ()
        {
            this.actGauge.On進行描画();
        }
        protected void t進行描画_KMD_コンボ()
        {
            this.actCombo.On進行描画();
        }
        protected void t進行描画_KMD_スコア()
        {
            this.actScore.On進行描画();
        }
        protected void t進行描画_KMD_ステータスパネル()
        {
            this.actStatusPanels.On進行描画();
        }
        protected bool t進行描画_KMD_チップ(E楽器パート ePlayMode)
        {
            if ((base.eフェーズID == CStage.Eフェーズ.演奏_STAGE_FAILED) || (base.eフェーズID == CStage.Eフェーズ.演奏_STAGE_FAILED_フェードアウト))
            {
                return true;
            ...
            for (int nCurrentTopChip = this.n現在のトップChip; nCurrentTopChip < dTX.listChip.Count; nCurrentTopChip++)
            {
                ...
                switch (pChip.nチャンネル番号)
                {
                    ...
                    case 0x1b:
                    case 0x1c:
                        this.t進行描画_KMD_チップ_KMD_ドラムス(configIni, ref dTX, ref pChip);
                        break;
                    #endregion
                    ...
                    case 0x08:	// BPM変更(拡張)
                        ...
                        {
                            pChip.bHit = true;
                            if (dTX.listBPM.ContainsKey(pChip.n整数値_KMD_内部番号))
                            {
                                this.actPlayInfo.dbBPM = (dTX.listBPM[pChip.n整数値_KMD_内部番号].dbBPM値 * (((double)configIni.n演奏速度) / 20.0)) + dTX.BASEBPM;
                    ...
                    case 0xD3:
                        ...
                        this.t進行描画_KMD_チップ_KMD_ギターベース(configIni, ref dTX, ref pChip, E楽器パート.GUITAR);
                        break;
                    #endregion
                    #region [ 28: ウェイリング(ギター) ]
                    case 0x28:	// ウェイリング(ギター)
                        this.t進行描画_KMD_チップ_KMD_ギター_KMD_ウェイリング(configIni, ref dTX, ref pChip);
                        break;
                    #endregion
                    ...
                    case 0x4D:
                    case 0x4E:
                    case 0x4F:  //追加した順番の都合上、4F、4E_KMD__KMD__KMD__KMD_という順でBonus1、Bonus2_KMD__KMD__KMD_という割り当てになってます。
                        //this.t進行描画_KMD_チップ_KMD_ボーナス(configIni, ref dTX, ref pChip);
                        if (!pChip.bHit && (pChip.nバーからの距離dot.Drums < 0))
                        {
                            pChip.bHit = true;
                        }
                    ...
                    #region [ 53: フィルイン ]
                    case 0x53:	// フィルイン
                        this.t進行描画_KMD_チップ_KMD_フィルイン(configIni, ref dTX, ref pChip);
                        break;
                    #endregion
                    #region [ 54, 5A: 動画再生 ]
                    case 0x54:	// 動画再生
                    ...
                    case 0x92:
                        if (!pChip.bHit && (pChip.nバーからの距離dot.Drums < 0))
                        {
                            ...
                            if (configIni.bBGM音を発声する)
                            {
                                ...
                                dTX.tチップの再生(pChip, CSound管理.rc演奏用タイマ.n前回リセットした時のシステム時刻 + pChip.n発声時刻ms, (int)Eレーン.BGM, dTX.nモニタを考慮した音量(E楽器パート.UNKNOWN));
                                this.n最後に再生したBGMの実WAV番号[pChip.nチャンネル番号 - 0x61] = pChip.n整数値_KMD_内部番号;
                            }
                        }
                        break;
                    #endregion
                    ...
                    case 0xE7:
                    case 0xE8:
                        this.t進行描画_KMD_チップ_KMD_ギターベース(configIni, ref dTX, ref pChip, E楽器パート.BASS);
                        break;
                    #endregion
                    #region [ a8: ウェイリング(ベース) ]
                    case 0xa8:	// ウェイリング(ベース)
                        this.t進行描画_KMD_チップ_KMD_ベース_KMD_ウェイリング(configIni, ref dTX, ref pChip);
                        break;
                    #endregion
                    ...
                    case 0xbd:
                    case 0xbe:
                        this.t進行描画_KMD_チップ_KMD_空打ち音設定_KMD_ドラム(configIni, ref dTX, ref pChip);
                        break;
                    #endregion
                    ...
                    case 0xEA:
                        if (!pChip.bHit && (pChip.nバーからの距離dot.Drums < 0))
                        {
                            ...
                            pChip.bHit = true;
                            if (listWAV.ContainsKey(pChip.n整数値_KMD_内部番号)) // 参照が遠いので後日最適化する
                            {
                                CDTX.CWAV wc = listWAV[pChip.n整数値_KMD_内部番号];
                                for (int i = 0; i < nPolyphonicSounds; i++)
                                {
        ...
        protected bool t進行描画_KMD_小節線(E楽器パート ePlayMode)
        {
            if ((base.eフェーズID == CStage.Eフェーズ.演奏_STAGE_FAILED) || (base.eフェーズID == CStage.Eフェーズ.演奏_STAGE_FAILED_フェードアウト))
            {
                return true;
            ...
            for (int nCurrentTopChip = this.n現在のトップChip; nCurrentTopChip < dTX.listChip.Count; nCurrentTopChip++)
            {
                ...
                switch (pChip.nチャンネル番号)
                {
                    ...
                    case 0x50:	// 小節線
                        {
                            this.t進行描画_KMD_チップ_KMD_小節線(configIni, ref dTX, ref pChip);
                            break;
                        }
                    #endregion
                    #region [ 51: 拍線 ]
        ...
        protected bool t進行描画_KMD_チップ_KMD_模様のみ(E楽器パート ePlayMode)
        {
            if ((base.eフェーズID == CStage.Eフェーズ.演奏_STAGE_FAILED) || (base.eフェーズID == CStage.Eフェーズ.演奏_STAGE_FAILED_フェードアウト))
            {
                return true;
            ...
            for (int nCurrentTopChip = this.n現在のトップChip; nCurrentTopChip < dTX.listChip.Count; nCurrentTopChip++)
            {
                ...
                switch (pChip.nチャンネル番号)
                {
                    ...
                    case 0x1b:
                    case 0x1c:
                        this.t進行描画_KMD_チップ_KMD_模様のみ_KMD_ドラムス(configIni, ref dTX, ref pChip);
                        break;
                    #endregion
                    #region [ その他(未定義) ]
                    default:
        ...
        protected abstract void t進行描画_KMD_チップ_KMD_ドラムス(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip);
        protected abstract void t進行描画_KMD_チップ_KMD_模様のみ_KMD_ドラムス(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip);
        //protected abstract void t進行描画_KMD_チップ_KMD_ギター( CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip );
        protected abstract void t進行描画_KMD_チップ_KMD_ギターベース(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip, E楽器パート inst);

        protected void t進行描画_KMD_チップ_KMD_ギターベース(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip, E楽器パート inst,
            ...
            int chipWidth, int guitarNormalX, int guitarLeftyX, int bassNormalX, int bassLeftyX, int drawDeltaX, int chipTexDeltaX)
        {
            ...
            if (configIni.bGuitar有効)
            {
                ...
                if ( autoPlayCondition )
                {
                    ...
                    // autoPickでない時の処理は、 t入力処理_KMD_ギターベース(E楽器パート) で行う
        ...
        protected virtual void t進行描画_KMD_チップ_KMD_ギターベース_KMD_ウェイリング(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip, E楽器パート inst)
        {
        ...
        protected virtual void t進行描画_KMD_チップ_KMD_ギター_KMD_ウェイリング(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip)
        {
            t進行描画_KMD_チップ_KMD_ギターベース_KMD_ウェイリング(configIni, ref dTX, ref pChip, E楽器パート.GUITAR);
        }
        protected abstract void t進行描画_KMD_チップ_KMD_フィルイン(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip);
        protected abstract void t進行描画_KMD_チップ_KMD_ボーナス(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip);
        protected void t進行描画_KMD_フィルインエフェクト()
        {
            this.actFillin.On進行描画();
        }
        protected abstract void t進行描画_KMD_チップ_KMD_小節線(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip);
        //protected abstract void t進行描画_KMD_チップ_KMD_ベース( CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip );
        protected virtual void t進行描画_KMD_チップ_KMD_ベース_KMD_ウェイリング(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip)
        {
            t進行描画_KMD_チップ_KMD_ギターベース_KMD_ウェイリング(configIni, ref dTX, ref pChip, E楽器パート.BASS);
        }
        protected abstract void t進行描画_KMD_チップ_KMD_空打ち音設定_KMD_ドラム(CConfigIni configIni, ref CDTX dTX, ref CDTX.CChip pChip);
        protected void t進行描画_KMD_チップアニメ()
        {
        ...
        protected bool t進行描画_KMD_フェードイン_KMD_アウト()
        {
            switch (base.eフェーズID)
            {
        ...
        protected void t進行描画_KMD_レーンフラッシュD()
        {
            if ((base.eフェーズID != CStage.Eフェーズ.演奏_STAGE_FAILED) && (base.eフェーズID != CStage.Eフェーズ.演奏_STAGE_FAILED_フェードアウト))
            {
        ...
        protected void t進行描画_KMD_レーンフラッシュGB()
        {
        ...
        protected abstract void t進行描画_KMD_演奏情報();
        protected void t進行描画_KMD_演奏情報(int x, int y)
        {
        ...
        protected void tDrawPerfectZone()
        {
            if (CDTXMania.ConfigIni.bDrums有効)
            {
                ...
                if (CDTXMania.ConfigIni.bShowPerfectRegion)
                {
                    // 2019.12.24 sub; Add perfect hit zone
                    // 1*22
                    // 2 * 15
                    // 
                    double scrollspeed = (this.act譜面スクロール速度.db現在の譜面スクロール速度.Drums + 1) * 0.5;
                    int deviation = (int)(scrollspeed * 15);
                    this.txPerfectZone.t2D描画(CDTXMania.app.Device, 295, y - (deviation / 2), 100, new Rectangle(0, 0, 0x209, deviation));
                }
            }
        }

        protected void t進行描画_KMD_判定ライン()
        {
            if (CDTXMania.ConfigIni.bDrums有効)
            {
                int y = CDTXMania.ConfigIni.bReverse.Drums ? nJudgeLinePosY.Drums - nJudgeLinePosY_delta.Drums : nJudgeLinePosY.Drums + nJudgeLinePosY_delta.Drums;
                if (CDTXMania.ConfigIni.bJudgeLineDisp.Drums)
                {
                    ...
                    this.txヒットバー.t2D描画(CDTXMania.app.Device, 295, y, new Rectangle(0, 0, 0x209, 6)); // 2019.12.23 sub; 0x22f for extra lane
                }
        ...
        protected void t進行描画_KMD_判定文字列()
        {
            this.actJudgeString.On進行描画();
        }
        protected void t進行描画_KMD_判定文字列1_KMD_通常位置指定の場合()
        {
        ...
        protected void t進行描画_KMD_判定文字列2_KMD_判定ライン上指定の場合()
        {
            if (((Eタイプ)CDTXMania.ConfigIni.判定文字表示位置.Drums) == Eタイプ.B)
            {
                this.actJudgeString.On進行描画();
        ...
        protected void t進行描画_KMD_譜面スクロール速度()
        {
        ...
        protected virtual void t入力処理_KMD_ギター()
        {
            t入力処理_KMD_ギターベース(E楽器パート.GUITAR);
        }
        protected virtual void t入力処理_KMD_ベース()
        {
            t入力処理_KMD_ギターベース(E楽器パート.BASS);
        }


        protected virtual void t入力処理_KMD_ギターベース(E楽器パート inst)
        {
            int indexInst = (int)inst;
            #region [ スクロール速度変更 ]
            ...
            //			else
            {
                ...
                if ((events != null) && (events.Count > 0))
                {
                    foreach (STInputEvent eventPick in events)
                    {
                        ...
                        if ((NoChipPicked != null) || ((NoChipPicked = this.r指定時刻に一番近いChip_KMD_ヒット未済問わず不可視考慮(nTime, chWailingSound, this.nInputAdjustTimeMs[indexInst])) != null))
                        {
                        ...
                        {
                            this.tチップのヒット処理_KMD_BadならびにTight時のMiss(inst);
                        }
                    }
                }
