	...
	internal class CActSelectPreimageパネル : CActivity
	{
		...
		public override int On進行描画()
		{
			if( !base.b活性化してない )
			{
				...
				this.t描画処理_KMD_パネル本体();
//				this.t描画処理_KMD_ジャンル文字列();
				this.t描画処理_KMD_プレビュー画像();
			}
			return 0;
		}
		...
		private void tプレビュー画像_KMD_動画の変更()
		{
			if( this.avi != null )
			{
				this.avi.Dispose();
		...
		private void t描画処理_KMD_ジャンル文字列()
		{
		...
		private unsafe void t描画処理_KMD_プレビュー画像()
		{
