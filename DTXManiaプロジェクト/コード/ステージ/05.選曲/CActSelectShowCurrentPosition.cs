	...
	internal class CActSelectShowCurrentPosition : CActivity
	{
		...
		public override int On進行描画()
		{
			...
			#region [ スクロールバーの描画 #27648 ]
                this.txScrollBar.t2D描画(CDTXMania.app.Device, x - (CDTXMania.stage選曲.ct登場時アニメ用共通.n現在の値 / 2f), y, new Rectangle(0, 0, 12, 492));	// 本当のy座標は88なんだが、なぜか約30のバイアスが掛かる_KMD__KMD__KMD_
			#endregion
