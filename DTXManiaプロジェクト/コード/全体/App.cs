...
namespace DTXMania
{
    class CApp : CApplicationForm
    {
        ...
        /// <para>Direct3Dデバイスのリセット_KMD_変更_KMD_再作成時に呼び出される。</para>
        /// </summary>
        ...
        */
                ...
                case Eアプリ状態.D3Dデバイスの変更:
                    {
                        if (this.bD3Dデバイスを変更する)
                        {
                            ...
                            this.tDirect3Dデバイスを生成_KMD_変更_KMD_リセットする(		// 例外はキャッチしない。準正常じゃなくて異常なので。
                                newSettings,
        ...
        /// <summary>
        /// <para>進行_KMD_描画スレッドの処理が完了したら、このイベントを Set() する。</para>
        /// </summary>
