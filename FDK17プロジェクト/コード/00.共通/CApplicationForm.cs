...
namespace FDK
{
	public class CApplicationForm : IDisposable
	{
		...
		/// </summary>
		public bool tDirect3Dデバイスを生成_KMD_変更_KMD_リセットする( CD3DSettings newD3DSettings, Size sz論理画面, uint wsウィンドウモード時のウィンドウスタイル, uint ws全画面モード時のウィンドウスタイル, bool bマウスカーソルの表示を制御する )
		{
			if( this.Window == null )
		...
		public bool tDirect3Dデバイスを生成_KMD_変更_KMD_リセットする( CD3DSettings newD3DSettings, Size sz論理画面, uint wsウィンドウモード時のウィンドウスタイル, uint ws全画面モード時のウィンドウスタイル )
		{
			return this.tDirect3Dデバイスを生成_KMD_変更_KMD_リセットする( newD3DSettings, sz論理画面, wsウィンドウモード時のウィンドウスタイル, ws全画面モード時のウィンドウスタイル, true );
		}
		public bool tDirect3Dデバイスを生成_KMD_変更_KMD_リセットする( CD3DSettings newD3DSettings, Size sz論理画面 )
		{
			return this.tDirect3Dデバイスを生成_KMD_変更_KMD_リセットする( newD3DSettings, sz論理画面, uint.MaxValue, uint.MaxValue, true );
		}
		public bool tDirect3Dデバイスを生成_KMD_変更_KMD_リセットする( CD3DSettings newD3DSettings )
		{
			return this.tDirect3Dデバイスを生成_KMD_変更_KMD_リセットする( newD3DSettings, Size.Empty, uint.MaxValue, uint.MaxValue, true );
		}
				...
				lock( this.obj排他用 )
				{
					...
					if( this.bデバイス消失中 )
					{
						...
						if( this.D3D9Device.TestCooperativeLevel() == ResultCode.DeviceNotReset )	// リセット可能
						{
							...
							try
							{
								if( this.tDirect3Dデバイスを生成_KMD_変更_KMD_リセットする( newSettings, CTexture.sz論理画面 ) )
								{
									// 作成成功。
